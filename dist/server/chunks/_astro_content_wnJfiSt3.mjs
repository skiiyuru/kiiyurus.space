...
import { A as AstroError, R as RenderUndefinedEntryError, c as createComponent, r as renderTemplate, u as unescapeHTML, U as UnknownContentCollectionError, h as renderUniqueStylesheet, i as renderScriptElement, j as createHeadAndContent, a as renderComponent } from './astro/server_B9k6C6bM.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BIqGQq34.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://kiiyurus.space", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_CIFcbriB.mjs').then(n => n._);
...
export { getEntries as a, getCollection as g, renderEntry as r };
